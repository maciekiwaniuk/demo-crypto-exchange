 ...
 */
final class Version20230217213914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, crypto_to_sell_id INT DEFAULT NULL, crypto_to_buy_id INT DEFAULT NULL, type VARCHAR(50) NOT NULL, status VARCHAR(255) NOT NULL, amount_of_crypto_to_sell DOUBLE PRECISION DEFAULT NULL, amount_of_crypto_to_buy DOUBLE PRECISION DEFAULT NULL, value DOUBLE PRECISION NOT NULL, done_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F5299398212FC935 (crypto_to_sell_id), INDEX IDX_F52993988A7AA766 (crypto_to_buy_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
